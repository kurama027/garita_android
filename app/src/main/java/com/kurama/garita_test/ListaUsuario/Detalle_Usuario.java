...
public class Detalle_Usuario extends AppCompatActivity {
    ...
    private void InicializarVistas(){
        ...
        Imagen_OU_D = findViewById(R.id.Imagen_OU_D);
    }
    ...
    private void ObtenerImagen(){
        ...
        try {
            ...
            Glide.with(getApplicationContext()).load(imagen).placeholder(R.drawable.paimon_lost).into(Imagen_OU_D);
